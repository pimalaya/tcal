...
tCal and tCard are one design written twice, so a reader who knows one should recognise the other on sight. Two headers written independently would lose that, and the projection, the fold-back and the merge forcing are the same three ideas in both.
