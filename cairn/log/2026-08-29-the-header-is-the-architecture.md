...
The projection's submodules are crate-private, so the header names them in prose rather than linking them: a public page linking a private item is a rustdoc warning. The projection module header itself carried four such links, which cargo doc had been warning about all along; they are plain names now too.
