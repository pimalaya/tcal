...
RELEASES_URL="https://github.com/pimalaya/tcal/releases"
...
curl -sLo "$tmpdir/tcal.tgz" \
     "$RELEASES_URL/latest/download/tcal.$target.tgz"

echo "Installing binary…"
tar -xzf "$tmpdir/tcal.tgz" -C "$tmpdir"
